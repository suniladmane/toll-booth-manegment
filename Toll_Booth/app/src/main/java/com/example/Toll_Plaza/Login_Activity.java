...
public class Login_Activity extends AppCompatActivity {
    ...
    public void onLogin(View view) {
        ...
        else
        {
            ...
            String url = "http://192.168.43.216:5000/user/login";
            //create body
                    ...
                    .setCallback(new FutureCallback<JsonObject>() {
                        ...
                        public void onCompleted(Exception e, JsonObject result) {
                            ...
                            else
                            {
                                ...
                                Toast.makeText(Login_Activity.this,"Welcome to my application",Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(Login_Activity.this,MainUserActivity.class);
                                String key = status;
                                intent.putExtra("UID",status);
